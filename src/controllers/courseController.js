...
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; } // Image
...
var putModule = /*#__PURE__*/function () {
  var _ref17 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee17(req, res, next) {
    var id, _req$body2, moduleId, title, children, course, module, isModuleExists;
    return _regenerator["default"].wrap(function _callee17$(_context17) {
      while (1) switch (_context17.prev = _context17.next) {
        case 0:
          id = req.params.id;
          _req$body2 = req.body, moduleId = _req$body2.moduleId, title = _req$body2.title, children = _req$body2.children;
          _context17.prev = 2;
          _context17.next = 5;
...
var addModuleChildren = /*#__PURE__*/function () {
  var _ref19 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee19(req, res, next) {
    var id, _req$body3, moduleId, title, course, module, titleExists, newModule;
    return _regenerator["default"].wrap(function _callee19$(_context19) {
      while (1) switch (_context19.prev = _context19.next) {
        case 0:
          _context19.prev = 0;
          id = req.params.id;
          _req$body3 = req.body, moduleId = _req$body3.moduleId, title = _req$body3.title;
          _context19.next = 5;
          return _coursesModel["default"].findById(id);
        case 5:
...
var checkCourseUser = /*#__PURE__*/function () {
  var _ref23 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee23(req, res, next) {
    var _req$body4, idUser, slugCourse, courseDetails, user, course;
    return _regenerator["default"].wrap(function _callee23$(_context23) {
      while (1) switch (_context23.prev = _context23.next) {
        case 0:
          _context23.prev = 0;
          _req$body4 = req.body, idUser = _req$body4.idUser, slugCourse = _req$body4.slugCourse;
          _context23.next = 4;
          return _coursesModel["default"].findOne({
            slug: slugCourse
          }).select('price module name');
        case 4:
